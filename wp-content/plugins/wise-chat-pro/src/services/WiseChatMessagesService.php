...
class WiseChatMessagesService {
	...
	*/
	 ...
	 */
	public function addMessage($user, $channel, $text, $isAdmin = false, $recipient = null) {
		$text = trim($text);
	 ...
	 * @throws Exception On validation error
	 */
	public function addMessageWithAttachments($user, $channel, $text, $attachments, $recipient = null) {
		$message = $this->addMessage($user, $channel, $text, false, $recipient);
	...
	public function getById($id) {
		return $this->messagesDAO->get($id);
	}
