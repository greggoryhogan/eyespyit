...
class WiseChatService {
	...
	*/
	...
	public function isExternalLoginEnabled() {
		return $this->options->isOptionEnabled('facebook_login_enabled', false) ||
				$this->options->isOptionEnabled('twitter_login_enabled', false) ||
				$this->options->isOptionEnabled('google_login_enabled', false);
	}
