...
class WiseChatAppearanceTab extends WiseChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('chat_width', 'Width', 'stringFieldCallback', 'string',
				'Allowed values: a number with or without an unit (px or %), default: 100%. <br />
				<strong>Notice:</strong> You cannot use percentage unit when Facebook-like mode is set. All values here will be converted into <strong>px</strong> unit.'
			),
			...
			array('private_messages_limit', 'Private Messages Limit', 'stringFieldCallback', 'integer', 'Maximum number of messages loaded on start-up for private conversations'),
			...
			array('input_controls_location', 'Input Controls Location', 'selectCallback', 'string',
				'Location of the input field, submit button and customizations panel section <br />
				<strong>Notice:</strong> This option makes no effect when Facebook-like mode is set.',
				WiseChatAppearanceTab::getInputFieldLocation()
			),
			...
			array('users_list_width', 'Users List Width', 'stringFieldCallback', 'integer',
				'Percentage width of the list of users. Empty field sets default value of 29%.<br />
				<strong>Notice:</strong> When Facebook-like mode is set this value is treated as <strong>px</strong> unit value.
				'
			),
	...
	public function getDefaultValues() {
		return array(
			...
			'fb_show_users_list_title' => 1,
			'fb_minimize_users_list_option' => 0,
    ...
    public function getParentFields() {
        return array(
			...
			'fb_minimize_users_list_option' => 'fb_show_users_list_title',
			'users_list_info_windows_template' => 'show_users_list_info_windows',
        );
    }
