...
class WiseChatLocalizationTab extends WiseChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('message_bp_manage_permissions_admins_delete', 'Label #7', 'stringFieldCallback', 'string', 'Label: "Allow admins to delete messages"'),
			array('message_bp_manage_permissions_admins_ban', 'Label #8', 'stringFieldCallback', 'string', 'Label: "Allow admins to ban users"'),
			array('message_bp_manage_notice', 'Label #9', 'stringFieldCallback', 'string', 'Label: "Notice:"'),
			array('message_bp_manage_notice_text', 'Label #10', 'stringFieldCallback', 'string', 'Label: "These permissions will work only with enabled admin actions in Wise Chat Pro settings"'),
			array('message_bp_manage_shortcode', 'Label #11', 'stringFieldCallback', 'string', 'Label: "Wise Chat Pro detailed parameters (shortcode syntax required)"'),
			array('message_bp_manage_shortcode_example', 'Label #12', 'stringFieldCallback', 'string', 'Label: "Example:"'),
			array('message_bp_chat_message', 'Label #13', 'stringFieldCallback', 'string', 'Label: "Chat Message"'),
		);
	}
