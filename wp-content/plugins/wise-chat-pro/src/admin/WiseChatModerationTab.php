...
class WiseChatModerationTab extends WiseChatAbstractTab {
	...
	public function getFields() {
		return array(
			array('_section', 'Moderation Permissions'),
			array('enable_message_actions', 'Enable Admin Actions', 'booleanFieldCallback', 'boolean',
				'Displays Approval, User Ban and Removal buttons next to each message. The buttons are visible only for roles defined below.<br />'.
				'<strong>Note:</strong> Approval button is visible only for pending messages. You can turn on Pending Messages feature below.'
			),
			array(
	...
	public function getParentFields() {
		return array(
			...
			'permission_edit_message_role' => 'enable_message_actions',
			'permission_approve_message_role' => 'enable_message_actions',
			...
			'enable_approval_confirmation' => 'enable_message_actions',
